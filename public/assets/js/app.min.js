...
(function ($) {
  ...
  $(document).on('click', '.navigation ul li a', function () {
    ...
    if ($this.next('ul').length) {
      ...
      $this.next('ul').toggle(200); // $this.parent('li').siblings().find('ul').not($this.parent('li').find('ul')).slideUp(200);
      ...
      $this.next('ul').find('li>a').find('.sub-menu-arrow').removeClass('rotate-in'); // $this.parent('li').siblings().not($this.parent('li').find('ul')).find('>a').find('.sub-menu-arrow').removeClass('fa-minus').addClass('fa-chevron-down');
