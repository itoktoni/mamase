...
<body>
	<div class="container" style="text-align: center;">
		...
		<h5 style="margin-top:10px;font-size:15px;margin-bottom:-5px;">
			<span style="margin-left: -20px;font-size:5px">.</span> <span style="margin-left: 20px">{{ $item->location_name }}</span>
		</h5>
		<h5 style="margin: 0px auto;text-align:center">
			<img style="margin-top:10px;height:70px" src="data:image/png;base64,{{BARCODE2D::getBarcodePNG(strval($item->location_id), 'QRCODE')}}" alt="barcode" />
		</h5>
