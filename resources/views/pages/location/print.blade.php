...
<body>
	<div class="container" style="text-align: center;">
		...
		<h5 style="margin-top:5px;font-size:15px;margin-bottom:-5px;">
			<span style="margin-left: -40px;font-size:5px">.</span> <span style="margin-left: 10px">{{ $item->location_name }}</span>
		</h5>
